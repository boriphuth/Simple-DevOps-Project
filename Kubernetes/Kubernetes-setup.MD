...
1. create an S3 bucket
   ```sh
    ...
    aws s3 mb s3://demo.k8s.valaxy1.net
   ```
1. Expose environment variable:
   ```sh
    export KOPS_STATE_STORE=s3://demo.k8s.valaxy.net
    export KOPS_STATE_STORE=s3://demo.k8s.valaxy1.net
   ```
...
1. Create kubernetes cluster definitions on S3 bucket
   ...
   kops create cluster --cloud=aws --zones=ap-southeast-1b --name=demo.k8s.valaxy1.net --dns-zone=valaxy1.net --dns private 
    ```

1. Create kubernetes cluser
    ```sh
    kops update cluster demo.k8s.valaxy.net --yes
    kops update cluster demo.k8s.valaxy1.net --yes
    ```
